...
/**
 * 
 * En esta clase se define la implementacion del Servidor con uno de respaldo,
 * que es un tipo de Servidor y que, por lo tanto, consiste en una
...
public class ServidorImplRespaldo implements Servidor {
	 ...
	 * 
	 * @param nombre
	 *            El nombre del servidor principal.
	 * @param servidorRespaldo
	 ...
	 * 
	 * @param nombre
	 *            El nombre del servidor de respaldo.
	 */
	...
	/**
	 * Este metodo se encarga de dar de alta un usuario en el servidor. En caso
	 * de que sea el servidor que tiene uno de respaldo, tambien lo da de alta
	 * en ese.
	 * 
	 * @return El token que se le devuelve al usuario para poder manejar el
	 *         resto de los metodos (similar a una password).
	 */
	public String alta() {
	...
	/**
	 * Este metodo se encarga de dar de baja del servidor a un usuario. Esto se
	 * realiza eliminando el token de la lista de tokens (tanto del servidor
	 * principal como del servidor de respaldo).
	 * 
	 * @param token
	 *            El token que se quiere dar de baja del servidor.
	 ...
	 * Simplemente se podra agregar en caso de que se le pase el token especial
	 * de administrador.
	 * 
	 * @param contenido
	 ...
	 * busqueda, pero con un anuncio cada tres de ellos. En caso de que no
	 * encuentre nada en el servidor principal, buscara en el de respaldo.
	 * 
	 * @param subcadena
